...
<body>
    <div id="main">
        <h3 id="ruler_title">Правила игрового форума:</h3>

            <h5 id="rules_number">1. Будьте вежливыми и уважительными:</h5>
               <p id="rules_text">- Не допускайте оскорблений, нецензурной лексики или личных нападок на других пользователей.</p>
               <p id="rules_text">- Проявляйте терпение и понимание к другим участникам сообщества.</p>
            
               <h5 id="rules_number">2. Соблюдайте тематику:</h5>
               <p id="rules_text">- Размещайте сообщения, относящиеся к обсуждаемой игре или игровой тематике.</p>
               <p id="rules_text">- Избегайте флуда, оффтопика и спама.</p>
            
               <h5 id="rules_number">3. Уважайте авторские права:</h5>
               <p id="rules_text">- Не публикуйте контент, на который у вас нет прав или разрешения (например, взломанные моды, пиратские копии игр).</p>
               <p id="rules_text">- Ссылайтесь на источники, если используете чужие материалы.</p>
            
               <h5 id="rules_number">4. Соблюдайте конфиденциальность:</h5>
               <p id="rules_text">- Не делитесь личной информацией других пользователей без их согласия.</p>
               <p id="rules_text">- Не публикуйте ссылки на вредоносные или незаконные ресурсы.</p>
            
               <h5 id="rules_number">5. Будьте ответственными:</h5>
               <p id="rules_text">- Не используйте форум для распространения ложной информации или слухов.</p>
               <p id="rules_text">- Не злоупотребляйте функциями модерации или администрирования.</p>
            
            <h5 id="rules_number">Администрация оставляет за собой право удалять или редактировать сообщения, нарушающие данные правила, а также применять санкции к нарушителям вплоть до блокировки учетной записи.</h5>
    </div>
